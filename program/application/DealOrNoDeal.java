...
public class DealOrNoDeal {
    // Ich lege die Werte der Koffer fest.
    ...
    // debugMode wird verwendet, um festzustellen, ob das Spiel im Debug-Modus ist oder nicht.
    private boolean debugMode = false;

    // chosenCase speichert den Koffer, den der Spieler ausgewählt hat.
    ...
    public void finalStage() {
        // Ich handle die letzte Phase des Spiels.
        Scanner scanner = new Scanner(System.in);
